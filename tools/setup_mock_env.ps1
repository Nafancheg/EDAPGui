...
# The Loadout is the owner's real explorer build (SLEF export from EDSY,
# 2026-07-17): explorer_nx with the size8 SCO MkII drive (supercharge x6,
# FSD_LongRange G4 -> FSDOptimalMass 6771.5) + guardian booster 5H, max jump
# range 78.4 LY. A Location event pins the current star system: the Phase
# 8.1 route planner needs ship_state()['location'] as the plot origin and
# loadout_raw's FSD for the fuel-safe/fast profiles / jump-range fallback.
...
{ "timestamp":"2026-07-06T14:00:05Z", "event":"LoadGame", "Commander":"TestCmdr", "FID":"F0000000", "Horizons":true, "Odyssey":true, "Ship":"explorer_nx", "Ship_Localised":"Explorer NX", "ShipID":1, "ShipName":"", "ShipIdent":"", "FuelLevel":32.000000, "FuelCapacity":32.000000, "GameMode":"Solo", "Credits":1000000, "Loan":0 }
{ "timestamp":"2026-07-06T14:00:06Z", "event":"Loadout", "Ship":"explorer_nx", "ShipName":"", "ShipIdent":"", "HullValue":0, "ModulesValue":20232511, "UnladenMass":1293.6, "CargoCapacity":32, "MaxJumpRange":78.410837, "FuelCapacity":{"Main":32, "Reserve":1.14}, "Rebuy":1011625, "Modules":[{"Slot":"CargoHatch", "Item":"modularcargobaydoor", "On":true, "Priority":0}, {"Slot":"Armour", "Item":"explorer_nx_armour_grade1", "On":true, "Priority":1, "Value":0}, {"Slot":"PowerPlant", "Item":"int_powerplant_size6_class5", "On":true, "Priority":1, "Value":12971097}, {"Slot":"MainEngines", "Item":"int_engine_size6_class2", "On":false, "Priority":0, "Value":599242}, {"Slot":"FrameShiftDrive", "Item":"int_hyperdrive_overcharge_size8_class5_overchargebooster_mkii", "On":true, "Priority":0, "Value":0, "Engineering":{"BlueprintName":"FSD_LongRange", "Level":4, "Quality":0, "Modifiers":[{"Label":"Mass", "Value":200, "OriginalValue":160}, {"Label":"Integrity", "Value":165.44, "OriginalValue":188}, {"Label":"PowerDraw", "Value":1.176, "OriginalValue":1.05}, {"Label":"FSDOptimalMass", "Value":6771.5, "OriginalValue":4670}]}}, {"Slot":"LifeSupport", "Item":"int_lifesupport_size5_class2", "On":true, "Priority":2, "Value":0}, {"Slot":"PowerDistributor", "Item":"int_powerdistributor_size3_class2", "On":true, "Priority":0, "Value":12662}, {"Slot":"Radar", "Item":"int_sensors_size8_class2", "On":true, "Priority":2, "Value":0}, {"Slot":"FuelTank", "Item":"int_fueltank_size5_class3", "On":true, "Priority":1, "Value":97754}, {"Slot":"Slot01_Size7", "Item":"int_fuelscoop_size7_class5", "On":true, "Priority":2, "Value":0}, {"Slot":"Slot03_Size6", "Item":"int_repairer_size6_class5", "On":true, "Priority":2, "Value":0}, {"Slot":"Slot04_Size5", "Item":"int_guardianfsdbooster_size5", "On":true, "Priority":0, "Value":6483100}, {"Slot":"Slot05_Size5", "Item":"int_shieldgenerator_size5_class2", "On":true, "Priority":2, "Value":0}, {"Slot":"Slot06_Size5", "Item":"int_dronecontrol_repair_size5_class2", "On":true, "Priority":2, "Value":0}, {"Slot":"Slot08_Size4", "Item":"int_cargorack_size4_class1", "On":true, "Priority":1, "Value":34328}, {"Slot":"Slot09_Size4", "Item":"int_cargorack_size4_class1", "On":true, "Priority":1, "Value":34328}, {"Slot":"Slot11_Size2", "Item":"int_dronecontrol_unkvesselresearch", "On":true, "Priority":2, "Value":0}, {"Slot":"Slot12_Size1", "Item":"int_detailedsurfacescanner_tiny", "On":true, "Priority":2, "Value":0}, {"Slot":"Slot13_Size1", "Item":"int_supercruiseassist", "On":true, "Priority":2, "Value":0}, {"Slot":"Slot14_Size1", "Item":"int_dockingcomputer_advanced", "On":true, "Priority":2, "Value":0}] }
{ "timestamp":"2026-07-06T14:00:07Z", "event":"Location", "StarSystem":"Devataru", "SystemAddress":5069269509577, "StarPos":[24.28125,19.34375,90.93750], "Body":"Devataru A", "BodyID":1, "BodyType":"Star", "Docked":false, "StationName":"", "StationType":"", "MarketID":0 }
'@

$liveFiles = @{
    'Cargo.json'       = '{ "timestamp":"' + $ts + '", "event":"Cargo", "Vessel":"Ship", "Count":0, "Inventory":[] }'
    'Status.json'      = '{ "timestamp":"' + $ts + '", "event":"Status", "Flags":16777240, "Flags2":0, "Pips":[4,8,0], "FireGroup":0, "GuiFocus":0, "Fuel":{ "FuelMain":32.000000, "FuelReservoir":1.140000 }, "Cargo":0.000000, "LegalState":"Clean" }'
